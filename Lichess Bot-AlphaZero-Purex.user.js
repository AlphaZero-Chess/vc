// ==UserScript==
// @name         Lichess Bot - PURE ALPHAZERO v7.0.0 STRATEGIC MASTERY EDITION
// @description  TRUE AlphaZero Echo - Strategic Depth, Opening Mastery, Defensive Excellence
// @author       Enhanced Human AI
// @version      7.0.0-ALPHAZERO-STRATEGIC-MASTERY
// @match         *://lichess.org/*
...
const CONFIG = {
    ...
    thinkingTimeMax: 10000,     // 10.0 seconds maximum (ultra-deep for longer games)
    premoveTime: 300,           // 0.3s for premoves
    humanMistakeRate: 0.002,    // 0.2% (superhuman accuracy)
    
    // Deep strategic search - ENHANCED for TACTICAL DOMINANCE
    baseDepth: 24,              // Base search depth (increased from 22)
    strategicDepth: 30,         // Depth for strategic positions (increased from 28)
    endgameDepth: 32,           // Endgame depth for perfect conversion (increased from 30)
    openingDepth: 24,           // Solid opening depth to avoid blunders (increased from 22)
    classicalDepth: 35,         // Extra depth for classical time controls (increased from 32)
    winningDepth: 30,           // Depth when winning (increased from 28)
    tacticalDepth: 32,          // NEW: Depth for tactical positions
    criticalDepth: 34,          // NEW: Emergency depth for critical positions
...
const ALPHAZERO_OPENINGS = {
    ...
    // Spanish Opening (Ruy Lopez) - Classical
    "r1bqkbnr/pppp1ppp/2n5/1B2p3/4P3/5N2/PPPP1PPP/RNBQK2R b KQkq -": {
        black: [
            { move: "a7a6", weight: 0.50, name: "Morphy Defense" },
            { move: "g8f6", weight: 0.30, name: "Berlin Defense" },
            { move: "f8c5", weight: 0.15, name: "Classical" },
            { move: "d7d6", weight: 0.05, name: "Steinitz Defense" }
        ]
    },
    ...
    "rnbqkbnr/ppp1pppp/8/3p4/2PP4/8/PP2PPPP/RNBQKBNR b KQkq -": {
        black: [
            ...
            { move: "g8f6", weight: 0.15, name: "QGD Main" },
            { move: "d5c4", weight: 0.10, name: "QGA" }
        ]
    },
    ...
    "rnbqkbnr/ppp1pppp/8/8/2pP4/8/PP2PPPP/RNBQKBNR w KQkq -": {
        white: [
            { move: "e2e3", weight: 0.50, name: "QGA Main" },
            { move: "g1f3", weight: 0.35, name: "QGA Classical" },
            { move: "e2e4", weight: 0.15, name: "QGA Aggressive" }
        ]
    },
    ...
    "rnbqk2r/pppp1ppp/4pn2/8/1bPP4/2N5/PP2PPPP/R1BQKBNR w KQkq -": {
        white: [
            { move: "e2e3", weight: 0.45, name: "Rubinstein Variation" },
            { move: "d1c2", weight: 0.30, name: "Classical Variation" },
            { move: "g1f3", weight: 0.15, name: "Kasparov Variation" },
            { move: "a2a3", weight: 0.10, name: "Saemisch Variation" }
        ]
    },
    
    // King's Indian Attack (vs various)
    "rnbqkb1r/ppp1pppp/5n2/3p4/8/5NP1/PPPPPP1P/RNBQKB1R w KQkq -": {
        white: [
            { move: "f1g2", weight: 0.60, name: "KIA Main" },
            { move: "d2d3", weight: 0.30, name: "KIA Solid" },
            { move: "c2c4", weight: 0.10, name: "Hybrid" }
        ]
    },
    ...
    "rnbqkbnr/ppp1pppp/8/3p4/4P3/8/PPPP1PPP/RNBQKBNR w KQkq -": {
        white: [
            { move: "e4d5", weight: 0.90, name: "Accept gambit" },
            { move: "b1c3", weight: 0.10, name: "Decline" }
        ]
    },
    ...
    "rnbqkb1r/ppp1pppp/3p1n2/8/3PP3/8/PPP2PPP/RNBQKBNR w KQkq -": {
        white: [
            { move: "b1c3", weight: 0.50, name: "Classical Pirc" },
            { move: "g1f3", weight: 0.30, name: "Solid setup" },
            { move: "f2f3", weight: 0.20, name: "Austrian Attack" }
        ]
    },
    ...
    "rnbqkb1r/pppppppp/5n2/8/4P3/8/PPPP1PPP/RNBQKBNR w KQkq -": {
        white: [
            { move: "e4e5", weight: 0.70, name: "Chase the knight" },
            { move: "b1c3", weight: 0.20, name: "Solid" },
            { move: "d2d3", weight: 0.10, name: "Quiet" }
        ]
    },
    ...
    "rnbqkb1r/ppp1pppp/5n2/3p4/3P1B2/5N2/PPP1PPPP/RN1QKB1R b KQkq -": {
        black: [
            { move: "e7e6", weight: 0.40, name: "Classical setup" },
            { move: "c7c5", weight: 0.35, name: "Challenge center" },
            { move: "b8d7", weight: 0.15, name: "Solid" },
    ...
    "rnbqkb1r/pppp1ppp/4pn2/8/2PP4/6P1/PP2PP1P/RNBQKBNR b KQkq -": {
        black: [
            { move: "d7d5", weight: 0.60, name: "Catalan main" },
            { move: "f8e7", weight: 0.25, name: "Solid" },
            { move: "c7c5", weight: 0.15, name: "Dynamic" }
        ]
    },
    ...
    "rnbqkb1r/ppp1pp1p/5np1/3p4/2PP4/2N5/PP2PPPP/R1BQKBNR w KQkq -": {
        white: [
            { move: "c4d5", weight: 0.45, name: "Exchange Variation" },
            { move: "g1f3", weight: 0.35, name: "Solid" },
            { move: "d1b3", weight: 0.20, name: "Russian System" }
        ]
    },
    ...
    "rnbqkbnr/ppppp1pp/8/5p2/3P4/8/PPP1PPPP/RNBQKBNR w KQkq -": {
        white: [
            { move: "g2g3", weight: 0.45, name: "Fianchetto" },
            { move: "g1f3", weight: 0.35, name: "Classical" },
            { move: "c2c4", weight: 0.20, name: "Stonewall setup" }
        ]
    },
    ...
    "rnbqkb1r/pp1p1ppp/4pn2/2pP4/8/2N5/PP2PPPP/R1BQKBNR w KQkq -": {
        white: [
            { move: "e2e4", weight: 0.50, name: "Modern Benoni" },
            { move: "g1f3", weight: 0.35, name: "Solid development" },
            { move: "e2e3", weight: 0.15, name: "Quiet" }
        ]
    },
    ...
    "rnbqkb1r/p2ppppp/5n2/1ppP4/2P5/8/PP2PPPP/RNBQKBNR w KQkq -": {
        white: [
            { move: "c4b5", weight: 0.60, name: "Accept gambit" },
            { move: "g1f3", weight: 0.30, name: "Decline" },
            { move: "b2b3", weight: 0.10, name: "Fianchetto decline" }
        ]
    },
    ...
    "r1bqkbnr/pppp1ppp/2n5/4p3/3PP3/5N2/PPP2PPP/RNBQKB1R b KQkq -": {
        black: [
            { move: "e5d4", weight: 0.70, name: "Main line" },
            { move: "g8f6", weight: 0.20, name: "Solid" },
            { move: "d7d6", weight: 0.10, name: "Philidor style" }
        ]
    },
    ...
    "r1bqkb1r/pppp1ppp/2n2n2/4p3/4P3/2N2N2/PPPP1PPP/R1BQKB1R w KQkq -": {
        white: [
            { move: "f1b5", weight: 0.50, name: "Spanish Four Knights" },
            { move: "d2d4", weight: 0.30, name: "Scotch Four Knights" },
            { move: "f1c4", weight: 0.20, name: "Italian Four Knights" }
        ]
    },
    ...
    "rnbqkbnr/pppp1ppp/8/4p3/4P3/2N5/PPPP1PPP/R1BQKBNR b KQkq -": {
        black: [
            { move: "g8f6", weight: 0.50, name: "Vienna main" },
            { move: "b8c6", weight: 0.30, name: "Classical" },
            { move: "f8c5", weight: 0.20, name: "Bishop out" }
        ]
    }
};
...
function initializeChessEngine() {
    ...
    chessEngine.postMessage("setoption name MultiPV value 12");        // INCREASED: See more tactical options (was 7)
