// ==UserScript==
// @name         Lichess Bot - PURE ALPHAZERO v5.0.0 ULTIMATE EDITION - TRUE ECHO
// @description  TRUE AlphaZero Echo - Explosive Creativity, Zero Draws, Perfect Endgames, DOMINATES ALL OPPONENTS
// @author       Enhanced Human AI
// @version      5.0.0-ALPHAZERO-ULTIMATE-TRUE-ECHO
// @match         *://lichess.org/*
...
/**
 * ═══════════════════════════════════════════════════════════════════════════
 * PURE ALPHAZERO BOT v5.0.0 - TRUE ALPHAZERO ECHO - ULTIMATE EDITION
 * ═══════════════════════════════════════════════════════════════════════════
 * 
...
let lastRejectedMove = null;          // Track last rejected move to prevent infinite loops
...
function startStuckDetectionWatchdog() {
    ...
    stuckDetectionTimer = setTimeout(() => {
        ...
        if (!calculationLock && currentFen && webSocketWrapper && webSocketWrapper.readyState === 1) {
            ...
            // Clear pending move and rejection tracking
            pendingMove = null;
